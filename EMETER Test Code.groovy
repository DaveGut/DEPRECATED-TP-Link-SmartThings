/*	Special trouble shooting code */
	def devVer()	{ return "Trouble Shooting" }
metadata {
...
log.error "energyMeterResponse:  cmdResponse = ${cmdResponse}"
log.error "energyMeterResponse:  state = ${state}"
log.error "energyMeterResponse:  emeter = ${cmdResponse["emeter"]}"
log.error "energyMeterResponse:  get_realtime = ${cmdResponse["emeter"]["get_realtime"]}"
...
log.error "useTodayResponse:  cmdResponse = ${cmdResponse}"
	def wattHrToday
	def wattHrData
...
*/
log.error "engrStatsResponse:  cmdResponse = ${cmdResponse}"
...
log.error "currentDateResponse: cmdResponse = ${cmdResponse}"
